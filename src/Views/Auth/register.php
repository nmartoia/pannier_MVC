  ...
  <form action="/register/" method="post">
    ...
    <div class="blockInput">
      <div class="labelInput">
        ...
        <input type="text" id="username" name="username" value="<?php echo old("username"); ?>" placeholder="username">
      </div>
      <span class="error">
    ...
    <div class="blockInput">
      <div class="labelInput">
        ...
        <input id="inputPasswordConfirm" class="inputPassword" type="password" name="passwordConfirm"
      ...
      <span class="error">
        <?php echo error("passwordConfirm"); ?>
      </span>
      <span class="error">
...
<script>
  ...
  btnPassConf.onclick = function () {
    ...
    //fonction qui sert a changer le format du input password confirm pour voire la valeur écrit dessus
  };
</script>
